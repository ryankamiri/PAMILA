...
CREATE UNIQUE INDEX IF NOT EXISTS listings_canonical_source_url_idx ON listings (canonical_source_url);
...
CREATE INDEX IF NOT EXISTS source_captures_listing_id_idx ON source_captures (listing_id);
...
CREATE INDEX IF NOT EXISTS commute_estimates_listing_id_idx ON commute_estimates (listing_id);
...
CREATE INDEX IF NOT EXISTS score_breakdowns_listing_id_idx ON score_breakdowns (listing_id);
